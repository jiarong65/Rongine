...
void Sandbox2D::onUpdate(Rongine::Timestep ts)
{
...

	{
		...
		Rongine::Renderer2D::drawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f },45.0f, m_checkerboardTexture,10.0f,glm::vec4(1.0f,0.8f,0.8f,0.5f));
		Rongine::Renderer2D::drawQuad(m_squarePosition, { 1.0f, 1.0f }, 60.0f,m_squareColor);
